...
=======
1. Clone/download my-recipes into your WordPress `wp-content/plugins/` directory.
2. Clone/download magic-bites into your WordPress `wp-content/themes/` directory.
3. Activate the plugin my-recipes via the WP admin dashboard.
4. Activate the theme magic-bites via the WP admin dashboard.
5. In your `wp-config.php`, add this line with your Spoonacular API key:
